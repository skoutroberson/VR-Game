...
public: \
	DECLARE_CLASS(AErrolSaw, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ArchitectureExplorer"), NO_API) \
...
#define ArchitectureExplorer_Source_ArchitectureExplorer_ErrolSaw_h_22_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, AErrolSaw); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(AErrolSaw); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API AErrolSaw(AErrolSaw&&); \
	NO_API AErrolSaw(const AErrolSaw&); \
public:
...
template<> ARCHITECTUREEXPLORER_API UClass* StaticClass<class AErrolSaw>();
