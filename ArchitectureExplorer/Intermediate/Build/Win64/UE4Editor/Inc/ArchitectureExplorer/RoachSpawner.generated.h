...
#ifdef ARCHITECTUREEXPLORER_RoachSpawner_generated_h
#error "RoachSpawner.generated.h already included, missing '#pragma once' in RoachSpawner.h"
#endif
...
public: \
	DECLARE_CLASS(ARoachSpawner, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ArchitectureExplorer"), NO_API) \
...
#define ArchitectureExplorer_Source_ArchitectureExplorer_RoachSpawner_h_14_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ARoachSpawner); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ARoachSpawner); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ARoachSpawner(ARoachSpawner&&); \
	NO_API ARoachSpawner(const ARoachSpawner&); \
public:
...
template<> ARCHITECTUREEXPLORER_API UClass* StaticClass<class ARoachSpawner>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID ArchitectureExplorer_Source_ArchitectureExplorer_RoachSpawner_h
